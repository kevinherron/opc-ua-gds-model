...
public class CertificateRequestedAuditEventTypeNode extends AuditUpdateMethodEventTypeNode implements CertificateRequestedAuditEventType {
  public CertificateRequestedAuditEventTypeNode(OpcUaClient client, NodeId nodeId,
